...
RAISE NOTICE '✅ Parent Sync Trigger applied';

-- 3. [Permissions] Fix 500 Error (Recursion)
ALTER TABLE public.user_profiles ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Admins can do everything" ON public.user_profiles; -- The culprit
-- Ensure simple access exists
